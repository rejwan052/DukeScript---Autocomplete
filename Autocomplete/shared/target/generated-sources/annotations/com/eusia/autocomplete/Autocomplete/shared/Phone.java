...
public final class Phone implements Cloneable {
  ...
  public java.lang.String getValidate() {
    ...
    try {
      proto.acquireLock();
      return com.eusia.autocomplete.Autocomplete.shared.Contacts.PhoneImpl.validate(arg1);
    } finally {
      proto.releaseLock();
    }
  }
  ...
  private com.eusia.autocomplete.Autocomplete.shared.PhoneType prop_type;
  public com.eusia.autocomplete.Autocomplete.shared.PhoneType getType() {
    proto.accessProperty("type");
    return prop_type;
  }
  public void setType(com.eusia.autocomplete.Autocomplete.shared.PhoneType v) {
    proto.verifyUnlocked();
    Object o = prop_type;
    if (TYPE.isSame(o , v)) return;
    prop_type = v;
  ...
  private static Class<Contacts.PhoneImpl> modelFor() { return null; }
  ...
  public Phone(java.lang.String aNumber, com.eusia.autocomplete.Autocomplete.shared.PhoneType aType) {
    this(net.java.html.BrwsrCtx.findDefault(Phone.class));
  ...
  private static class Html4JavaType extends org.netbeans.html.json.spi.Proto.Type<Phone> {
    private Html4JavaType() {
      ...
      registerProperty("validate", 0, true);
      registerProperty("number", 1, false);
      registerProperty("type", 2, false);
    }
    @Override public void setValue(Phone data, int type, Object value) {
      switch (type) {
        ...
        case 2: data.setType(TYPE.extractValue(com.eusia.autocomplete.Autocomplete.shared.PhoneType.class, value)); return;
      }
  ...
  private Phone(net.java.html.BrwsrCtx c, Object json) {
    ...
    try {
    this.prop_type = ret[1] == null ? null : com.eusia.autocomplete.Autocomplete.shared.PhoneType.valueOf(TYPE.stringValue(ret[1]));
  ...
  public String toString() {
    ...
    sb.append(TYPE.toJSON(prop_number));
    sb.append(',');
