package com.eusia.autocomplete.Autocomplete.shared;
...
public final class Contact implements Cloneable {
  ...
  public java.lang.String getFullName() {
    ...
    try {
      proto.acquireLock();
      return com.eusia.autocomplete.Autocomplete.shared.Contacts.fullName(arg1, arg2);
    } finally {
      proto.releaseLock();
    }
  }
  public java.lang.String getCallInfo() {
    ...
    try {
      ...
      return com.eusia.autocomplete.Autocomplete.shared.Contacts.callInfo(arg1);
    } finally {
      proto.releaseLock();
    }
  }
  public java.lang.String getValidate() {
    java.lang.String arg1 = getFirstName();
    java.lang.String arg2 = getLastName();
    com.eusia.autocomplete.Autocomplete.shared.Address arg3 = getAddress();
    java.util.List<Phone> arg4 = getPhones();
    try {
      proto.acquireLock("validate");
      return com.eusia.autocomplete.Autocomplete.shared.Contacts.validate(arg1, arg2, arg3, arg4);
    } finally {
      proto.releaseLock();
    }
  }
  ...
  private static Class<Contacts> modelFor() { return null; }
  ...
  private static class Html4JavaType extends org.netbeans.html.json.spi.Proto.Type<Contact> {
    private Html4JavaType() {
      ...
      registerProperty("fullName", 0, true);
      registerProperty("callInfo", 1, true);
      registerProperty("validate", 2, true);
      registerProperty("id", 3, false);
      registerProperty("firstName", 4, false);
      registerProperty("lastName", 5, false);
      registerProperty("address", 6, false);
      registerProperty("phones", 7, false);
    }
  ...
  public String toString() {
    ...
    sb.append(TYPE.toJSON(prop_firstName));
    sb.append(',');
    sb.append('"').append("lastName").append('"').append(":");
    sb.append(TYPE.toJSON(prop_lastName));
    sb.append(',');
    sb.append('"').append("address").append('"').append(":");
    sb.append(TYPE.toJSON(prop_address));
    sb.append(',');
    sb.append('"').append("phones").append('"').append(":");
    sb.append(TYPE.toJSON(prop_phones));
    sb.append('}');
    return sb.toString();
  }
  ...
  private Contact clone(net.java.html.BrwsrCtx ctx) {
    ...
    ret.prop_address =  getAddress()  == null ? null : prop_address.clone();
  ...
  public boolean equals(Object o) {
    ...
    if (!TYPE.isSame(prop_address, p.prop_address)) return false;
    if (!TYPE.isSame(prop_phones, p.prop_phones)) return false;
    return true;
  }
  public int hashCode() {
    ...
    h = TYPE.hashPlus(prop_address, h);
    h = TYPE.hashPlus(prop_phones, h);
    return h;
  }
}
