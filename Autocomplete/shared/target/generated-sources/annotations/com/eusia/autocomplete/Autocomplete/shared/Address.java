...
public final class Address implements Cloneable {
  ...
  public java.lang.String getValidate() {
    ...
    try {
      proto.acquireLock();
      return com.eusia.autocomplete.Autocomplete.shared.Contacts.AddressImpl.validate(arg1, arg2);
    } finally {
      proto.releaseLock();
    }
  }
  ...
  private static Class<Contacts.AddressImpl> modelFor() { return null; }
  ...
  private static class Html4JavaType extends org.netbeans.html.json.spi.Proto.Type<Address> {
    private Html4JavaType() {
      ...
      registerProperty("street", 1, false);
      registerProperty("town", 2, false);
    }
  ...
  public String toString() {
    ...
    sb.append(TYPE.toJSON(prop_street));
    sb.append(',');
    sb.append('"').append("town").append('"').append(":");
    sb.append(TYPE.toJSON(prop_town));
    sb.append('}');
    return sb.toString();
  }
